//! `frankfurter` vendor adapter. Owner: `neobank-wallet` (Phase 1). See plan/TASKS.md.
//!
...
/// Push this vendor's registration if it is active (`loaded.vendor_status("frankfurter")`).
