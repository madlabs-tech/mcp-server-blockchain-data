...
| [ ] | **GoPlus** (key optional: works keyless at the public rate) | https://gopluslabs.io/security-api | `GOPLUS_APP_KEY` + `GOPLUS_APP_SECRET` | 30 req/min | `token_check_risk` (primary), approval risk | Create an app to get the key + secret pair. Docs: https://docs.gopluslabs.io/reference/api-overview |
...
| [ ] | **TRM Labs (sanctions)** (key optional: works keyless at 100/day) | https://www.trmlabs.com/products/sanctions | `TRM_API_KEY` | **100 req/day**, 1 req/s | `compliance_screen_address` (alongside the free on-chain Chainalysis oracle) | Free sanctions-screening API. Docs: https://docs.sanctions.trmlabs.com/. Results are proprietary, so don't redistribute them in bulk. |
